package saic.research.webservice3.controller;
...
@RestController
public class Webservice3Controller {

    private static final Logger logger = LoggerFactory.getLogger(Webservice3Controller.class);
    ...
    public ResponseEntity<String> healthCheck()
    {
		...
		return ResponseEntity.status(HttpStatus.OK).body("Webservice3 researchRecordsService is healthy.");
    }
